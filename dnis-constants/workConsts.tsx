export const workConsts = {
  EN: [
    ...
    },
    {
      ...
      descriptionTwo:
        "I contributed to the development of an intricate private health insurance platform for Danish 🇩🇰 residents. The platform promises seamless integration with Denmark's public health and pension systems, serving as a comprehensive solution for healthcare management.",
      descriptionThree:
    ...
    },
    {
      title: "Amplio",
      description:
        "AMPLIO played an instrumental role in modernising the entire Danish welfare system – from health insurance to social benefits, and auditing authorities.",
      descriptionTwo:
    ...
    },
    {
      ...
      description:
        "During my engagement with The North Face, a captivating freelance project, I embarked on a journey filled with creativity and excitement. Tasked with a myriad of responsibilities, from editing images and videos to developing plugins for their web framework, my role was diverse and dynamic. One of the highlights of this endeavor was crafting engaging popups that enhanced the user experience on their web platform. Through a fusion of technical expertise and artistic flair, I contributed to North Face's digital landscape, leaving a mark that resonated with both the team and their audience.",
      descriptionTwo: "",
      descriptionThree: "",
      descriptionFour: "",
      imgSrc: "",
